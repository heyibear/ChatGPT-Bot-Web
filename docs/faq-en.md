...
- Select your ChatGPT-Bot-Web project;
...
2. When deploying the project, set the environment variable CODE (supports multiple passwords, separated by commas). After setting the access password, users need to enter the access password in the settings page to use it. See [related instructions](https://github.com/heyibear/ChatGPT-Bot-Web#access-password)

## Why doesn't the version I deployed have streaming response
> Related discussion: [#386](https://github.com/heyibear/ChatGPT-Bot-Web/issues/386)
...
Please refer to: [#371](https://github.com/heyibear/ChatGPT-Bot-Web/issues/371)

## Why is my Token consumed so fast?
> Related discussion: [#518](https://github.com/heyibear/ChatGPT-Bot-Web/issues/518)
