...
2. 点击右侧按钮开始部署：
   [![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https%3A%2F%2Fgithub.com%2Fheyibear%2FChatGPT-Bot-Web&env=OPENAI_API_KEY&env=CODE&project-name=ChatGPT-Bot-Web&repository-name=ChatGPT-Bot-Web)，直接使用 Github 账号登录即可，记得在环境变量页填入 API Key 和[页面访问密码](#配置页面访问密码) CODE；
3. 部署完毕后，即可开始使用；
...
> **警告**：请务必将密码的位数设置得足够长，最好 7 位以上，否则[会被爆破](https://github.com/heyibear/ChatGPT-Bot-Web/issues/518)。
...
[见项目贡献者列表](https://github.com/heyibear/ChatGPT-Bot-Web/graphs/contributors)
